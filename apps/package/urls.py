...
urlpatterns = [
    ...
    path('reader_<str:reader_id>/rversions/versions', ReaderVersionsView.as_view(), name='versions'),
    # 返回当前阅读器所有的已同步更新的所有版本的所有信息，历史版本
    path('reader_<str:reader_id>/rversions', ReaderRVersionsView.as_view(), name='rversions'),
